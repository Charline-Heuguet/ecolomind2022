    ...
    methods : {
        async ClickFav(){
            ...
            if (buttonFav.classList.contains("fav")){
                axios.post('https://back.ecolomind.fr/wp-json/wp/v2/ecolomind/unfavorites', JSON.parse(JSON.stringify(this.favData)))
             .then()
            .catch(function(){
            ...
            if (buttonFav.classList.contains("unfav")){
                ...
                axios.post('https://back.ecolomind.fr/wp-json/wp/v2/ecolomind/favorites', JSON.parse(JSON.stringify(this.favData)))
             .then()
             .catch(function(){
